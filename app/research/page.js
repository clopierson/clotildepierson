...
const title = "Research | RadiantLab";
const description =
...
export default function Research() {
  return (
    <>
      <StructuredData data={researchJsonLd} />
      ...
      <div className="prose prose-neutral dark:prose-invert mx-auto my-8">
        ...
        <h2 id="light-and-occupants">Light, Views, and Occupant Health</h2>
        ...
        <h2 id="energy-and-environment">Energy Consumption and Daylighting</h2>
